        ...
        <div className="mb-0 px-4 pt-2">
          <div className="flex flex-col gap-y-3 md:flex-row md:gap-x-2">
            ...
            <div className="flex flex-col self-center">
              <Link
                to={`/seller-profile/${lowerCase(gig.username as string)}/${gig.sellerId}/view`}
              ...
              <div className="flex w-full justify-center pt-1 md:justify-start">
                <div
                  className={cn('flex w-full justify-center md:justify-start', {
                    'gap-x-[5.8rem]': seller.ratingsCount === 0,
                    'gap-x-5': seller.ratingsCount && seller.ratingsCount > 0
                  })}
                >
          ...
          <div className="ml-15 mb-2 flex w-full py-1">
            <Button
              ...
              className={cn('text-md flex w-full justify-between rounded bg-sky-500 px-8 py-2 font-bold text-white focus:outline-none', {
                'opacity-50 cursor-not-allowed': authUser.username === gig.username,
                'cursor-pointer': authUser.username !== gig.username
              })}
              onClick={() => {
