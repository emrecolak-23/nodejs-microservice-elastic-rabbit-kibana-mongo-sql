...
const ManageEarningsTable: FC<IOrderTableProps> = ({ orders, type, orderTypes }): ReactElement => {
              ...
              {orders.map((order: IOrderDocument) => {
                return (
                  <tr key={order.orderId} className="bg-white border-b border-grey flex flex-col flex-nowrap sm:table-row mb-2 sm:mb-0 ">
                    ...
                    <td className="p-3 text-left md:text-center lowercase">{lowerCase(order.buyerUsername)}</td>
