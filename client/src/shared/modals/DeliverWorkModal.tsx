          ...
          <div className="relative bottom-auto left-auto right-auto top-auto max-h-[90vh] min-w-[500px] bg-white p-4">
            ...
            <div>
              <TextAreaInput
                ...
                value={description}
                onChange={(e: ChangeEvent) => setDescription((e.target as HTMLTextAreaElement).value)}
                rows={4}
              />
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                className={cn(
                  ...
                  {
                    'cursor-not-allowed bg-sky-200': !description || !selectedFile,
                    'bg-sky-500 hover:bg-sky-400': description && selectedFile
                  }
                )}
                label="Deliver"
                onClick={deliverWork}
