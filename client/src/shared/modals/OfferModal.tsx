...
const OfferModal: FC<IModalProps> = ({ header, gigTitle, receiver, authUser, singleMessage, cancelBtnHandler }): ReactElement => {
  ...
  const sendGigOffer = async (): Promise<void> => {
    try {
      ...
      showErrorToast('Something went wrong while sending the offer');
      console.log(error);
    }
  };
              ...
              <div className="relative mb-5 mt-2">
                <TextInput
                  ...
                  onChange={(event: ChangeEvent) => {
                    ...
                    setOffer({ ...offer, price: parseInt(value) ? value : '' });
                  }}
                />
              </div>
            </div>
          ...
          <div className="px-5 py-4">
            <div className="ml-2 flex w-full justify-center text-sm font-medium">
              <Button
                ...
                disabled={!offer.description || !offer.price || !offer.delivery || !offer.deliveryDate}
                label="Send Offer"
